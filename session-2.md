...
5. GitHub asks whether Claude can access your account. Press the green
   **Authorize** button
6. Back in the repo list, search for `2026-sdg-04` and click
   **LMU-GLP/2026-sdg-04**

**Repo not in the list?** You haven't accepted the invitation to it yet. Open
**[github.com/LMU-GLP/2026-sdg-04/invitations](https://github.com/LMU-GLP/2026-sdg-04/invitations)**
...
[github.com/LMU-GLP/2026-sdg-04](https://github.com/LMU-GLP/2026-sdg-04).
...
- [Los Angeles](sources/la-chronic-absenteeism.md)
- [South Korea](sources/korea-private-education.md)

This prompt reads them, finds three more, and builds the wiki from all five.

```
Set up this repo as an LLM wiki for our challenge: "How might we make learning more accessible, engaging, or useful for students who face barriers at school?"
...
https://sdgs.un.org/goals/goal4, one dataset with real figures, and one
...
[your repo](https://github.com/LMU-GLP/2026-sdg-04) and click the
**Pull requests** tab.
...
**[github.com/LMU-GLP/2026-sdg-04/tree/main/wiki](https://github.com/LMU-GLP/2026-sdg-04/tree/main/wiki)**
...
**https://lmu-glp.github.io/2026-sdg-04/**
...
[your repo](https://github.com/LMU-GLP/2026-sdg-04) → **Pull requests** tab.
