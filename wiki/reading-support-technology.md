# Reading-Support Technology: LucidRead (California)

A working example of a program already trying to solve a version of this problem — useful
as a reference point for "what has someone else already built."
...
- **Decoding difficulty** — syllable splitting, morpheme highlighting, bionic reading,
  picture dictionary, text-to-speech, sentence simplification.
- **Visual stress** — color overlays, the Lexend font, dark mode, high contrast, line
  tracking.
...
California **"was the 40th state to mandate universal dyslexia screening"** (K–2, starting
2025–2026) and allocated **$40 million** for screening tools and teacher training — but,
...
bottleneck) measured in two different ways — they are not directly comparable figures, and
this wiki does not treat them as such.
